...
mkdir -p ${UNIFIED_DIR}/${FWNAME}.framework/Headers/${FWNAME}
...
cp -r ${UNIFIED_DIR}/include/${FWNAME}/* ${UNIFIED_DIR}/${FWNAME}.framework/Headers/${FWNAME}/
...
cp ${EXEC_DIR}/tools/openssl_for_ios_umbrella.h ${UNIFIED_DIR}/${FWNAME}.framework/Headers/umbrella.h
